...
if ~isempty(FILES)
    ...
    e18 = uicontrol('Style','text',...
        ...
        'BackgroundColor',backColor,...
        'HorizontalAlignment', 'left',...
        'String',FILES(CUR_FILE).mainchannel,...
        'TooltipString', 'LFP Main channel',...
        'Parent',tab1);
    e18.String = FILES(CUR_FILE).mainchannel;
    uicontrol('Style','text',...
        'Units','characters',...
    ...
    edits = [e1;e2;e3;e4;e5;e6;e7;e8;e9;e10;e11;e12;e13;e14;e15;e16;e17;e18;e19;e20;e21;e22;e23;e100];
