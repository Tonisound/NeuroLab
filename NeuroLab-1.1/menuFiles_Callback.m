...
if ~isempty(FILES)
    ...
    uicontrol('Style','text',...
        'Units','characters',...
        'Position',[2 pos(4)-46 20 2],...
        'BackgroundColor',panelColor,...
        'HorizontalAlignment', 'left',...
        'String','Session type',...
        'Parent',tab1);
    e23 = uicontrol('Style','text',...
        'Units','characters',...
        'Position',[22 pos(4)-46.5 38 1.5],...
        'BackgroundColor',backColor,...
        'HorizontalAlignment', 'left',...
    ...
    e100 = uicontrol('Style','text',...
        'Units','characters',...
        'Position',[62 pos(4)-53 pos(3)-67 48],...
        'HorizontalAlignment', 'left',...
        'BackgroundColor','w',...
        'String','',...
    ...
    edits = [e1;e2;e3;e4;e5;e6;e7;e8;e9;e10;e11;e12;e13;e14;e15;e16;e17;e18;e18b;e19;e20;e21;e22;e23;e100];
...
switch flag
    ...
    function uitable_select(hObj,evnt,edits)
        ...
        if ~isempty(evnt.Indices)
            ...
            edits(18).String = files_temp(cur_file).mainlfp;
            edits(19).String = files_temp(cur_file).mainemg;
            edits(20).String = files_temp(cur_file).dir_lfp;
            edits(21).String = files_temp(cur_file).dir_ext;
            edits(22).String = data_norm.normalization;
            edits(23).String = sprintf('%s [%s]',data_ref.reference,data_ref.padding);
            edits(24).String = files_temp(cur_file).type;
