...
h12 = uicontrol(f,'Style','popup',...
    'Units','normalized',...
    'String','Doppler_source|Doppler_normalized|Doppler_dB|Differential Movie',...
...
pl_str = strcat(pl_str,'|Divide LFP Frequency Bands|Detect Vascular Surges|Detect Locomotion Events|Detect Left-Right Runs|Detect Early-Mid-Late Runs');
