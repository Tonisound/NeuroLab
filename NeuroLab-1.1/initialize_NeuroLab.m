...
h12 = uicontrol(f,'Style','popup',...
    'Units','normalized',...
    'String','Doppler_film|Doppler_normalized|Differential Movie|Doppler_dB',...
...
fl_str = strcat(fl_str,'|(Figure) Correlation Analysis|(Figure) LFP Wavelet Analysis|(Figure) fUS Episode Statistics|(Figure) fUS Fourier Analysis');
...
mb = uicontrol(f,'Style','checkbox',...
    ...
    'Parent',centerPanel);
% handles.AtlasBox
ab = uicontrol(f,'Style','checkbox',...
    'Units','normalized',...
    'TooltipString','Atlas Display',...
    'Tag','AtlasBox',...
    'Value',0,...
    'Parent',centerPanel);
% handles.CLimBox
...
% Time group patches (sleep stages)
% handles.TimePatchBox
h42bis = uicontrol(f,'Style','checkbox',...
    'Units','normalized',...
    'TooltipString','Show Sleep Stages',...
    'Tag','TimePatchBox',...
    'Value',0,...
    'Parent',rightPanel);
...
set(myhandles.EditMenu_Neuroshop,'Callback','NeuroShopStart(myhandles);');
