...
if get(src,'Value') == 1
    ...
    if strcmp(strtrim(handles.RightPanelPopup.String(handles.RightPanelPopup.Value,:)),'Trace Dynamics')
        return;
    end
    
    delta = .2*(handles.RightAxes.YLim(2)-handles.RightAxes.YLim(1));
