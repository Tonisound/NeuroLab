...
cload_extension = uicontrol('Style','text',...
    ...
    'Parent',tab3);
cload_extension.UserData.format={'raw';'differential';'full'};
cload_format = uicontrol('Style','popup',...
    'Units','characters',...
    'String',str,...
    'Value',GImport.Channel_loading_index,...
    'TooltipString','raw|differential|full',...
    'UserData',1,...
    'Position',[32 pos(4)-22.5 30 2],...
    'BackgroundColor',panelColor,...
    'Parent',tab3);
