...
global SEED STR_SAVE SEED_SWL SEED_REGION SEED_CONFIG SEED_ATLAS DIR_SAVE DIR_FIG DIR_STATS DIR_SYNT ;
...
set(resetAllparamButton,'Callback',@resetAllparamButton_callback);
    ...
    function okButton_callback(~,~)
        ...
        % SEED SEED_SWL Update
        SEED = get(ui_seed,'String');
        STR_SAVE = get(ui_str_save,'String');
        SEED_SWL = strrep(get(ui_seed_swl,'String'),'~',STR_SAVE);
        SEED_REGION = strrep(get(ui_seed_region,'String'),'~',STR_SAVE);
        SEED_CONFIG = strrep(get(ui_seed_config,'String'),'~',STR_SAVE);
        SEED_ATLAS = strrep(get(ui_seed_atlas,'String'),'~',STR_SAVE);
        DIR_SAVE = strrep(get(ui_dir_save,'String'),'~',STR_SAVE);
        DIR_FIG = strrep(get(ui_dir_fig,'String'),'~',STR_SAVE);
        DIR_STATS = strrep(get(ui_dir_stats,'String'),'~',STR_SAVE);
        DIR_SYNT = strrep(get(ui_dir_synt,'String'),'~',STR_SAVE);
        ...
        GTraces.AliasMainLFP = get(aliaslfp,'String');
        ...
        GImport.jump_proportion = str2double(get(jump_proportion,'String'));
        ...
        GImport.str_baseline1 = get(str_baseline1,'String');
        GImport.str_baseline2 = get(str_baseline2,'String');
        GImport.str_baseline3 = get(str_baseline3,'String');
        GImport.strict_baseline = get(strict_baseline,'Value');
        ...
        GImport.LFP_exporting = char(lexport_extension.UserData.format(lexport_format.Value));
        GImport.LFP_exporting_index = lexport_format.Value;        
        ...
        GImport.sticker_fontsize = str2double(get(sticker_fontsize,'String'));
        GImport.pattern_ignore1 = get(pattern_ignore1,'String');
        GImport.pattern_ignore2 = get(pattern_ignore2,'String');
        GImport.f_def = str2double(get(f_def,'String'));
        GImport.ledger_name = char(ledger_name.String(ledger_name.Value,:));
        GImport.ledger_importmode = char(ledger_importmode.String(ledger_importmode.Value,:));
        
        GParams.SEED = SEED;
        GParams.STR_SAVE = STR_SAVE;
        GParams.SEED_REGION = SEED_REGION;
        GParams.SEED_SWL = SEED_SWL;
        GParams.SEED_CONFIG = SEED_CONFIG;
        GParams.SEED_ATLAS = SEED_ATLAS;
        ...
        GFilt.beta_inf = str2double(get(ui_beta_inf,'String'));
        GFilt.beta_sup = str2double(get(ui_beta_sup,'String'));
        GFilt.beta_smooth = str2double(get(ui_beta_smooth,'String'));
        ...
        GFilt.ripple_detection_algo = char(ripple_detection_algo.String(ripple_detection_algo.Value,:));
    ...
    function checkdir_callback(hObj,~,var,label)
        ...
        all_labels = {'SEED_SWL';'SEED_REGION';'SEED_CONFIG';'SEED_ATLAS';'DIR_SAVE';'DIR_FIG';'DIR_STATS';'DIR_SYNT'};
        
        if sum(strcmp(label,all_labels))>0
                StrValue = strrep(StrValue,'~',STR_SAVE);
        end
        ...
        if isdir(StrValue) && strcmp(StrValue,var)==0
            if ~strcmp(StrValue(end),filesep)
                ...
                if sum(strcmp(label,all_labels))>0
                    set(hObj,'String',strrep(StrValue,STR_SAVE,'~'));
                else
        ...
        elseif isdir(StrValue)==0
            ...
            if sum(strcmp(label,all_labels))>0
                set(hObj,'String',strrep(var,STR_SAVE,'~'));
            else
                set(hObj,'String',var)
            end
            return;
...
uicontrol('Style','text',...
    ...
    'String','NEUROLAB Directory',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab0);
ui_str_save = uicontrol('Style','edit',...
    'Units','characters',...
    'String',STR_SAVE,...
    'TooltipString','STR_SAVE',...
    'UserData',GParams_default.STR_SAVE,...
    'Position',[22 pos(4)-10 W-24 2],...
    'Callback',{@checkdir_callback,STR_SAVE,'STR_SAVE'},...
    'BackgroundColor',panelColor,...
    'Parent',tab0);
...
ui_seed_swl = uicontrol('Style','edit',...
    'Units','characters',...
    'String',strrep(SEED_SWL,STR_SAVE,'~'),...
    'TooltipString','SEED_SWL',...
    'UserData',strrep(GParams_default.SEED_SWL,STR_SAVE,'~'),...
    'Position',[22 pos(4)-12 W-24 2],...
...
ui_seed_region = uicontrol('Style','edit',...
    'Units','characters',...
    'String',strrep(SEED_REGION,STR_SAVE,'~'),...
    'TooltipString','SEED_REGION',...
    'UserData',strrep(GParams_default.SEED_REGION,STR_SAVE,'~'),...
...
ui_seed_config = uicontrol('Style','edit',...
    'Units','characters',...
    'String',strrep(SEED_CONFIG,STR_SAVE,'~'),...
    'TooltipString','SEED_CONFIG',...
    'UserData',strrep(GParams_default.SEED_CONFIG,STR_SAVE,'~'),...
...
ui_seed_atlas = uicontrol('Style','edit',...
    'Units','characters',...
    'String',strrep(SEED_ATLAS,STR_SAVE,'~'),...
    'TooltipString','SEED_ATLAS',...
    'UserData',strrep(GParams_default.SEED_ATLAS,STR_SAVE,'~'),...
...
ui_S = uitable('ColumnName',{'color','info','dotstyle','info','linestyle','info'},...
    ...
    'ColumnWidth',{120 100 100 100 100 100},...
...
uicontrol('Style','text',...
    ...
    'HorizontalAlignment','left',...
    'String','Main LFP Alias',...
    'BackgroundColor',panelColor,...
    'Parent',tab2);
aliaslfp = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GTraces.AliasMainLFP,...
    'TooltipString','Duplicate Channel Name',...
    'UserData',GTraces_default.AliasMainLFP,...
    'Callback',{@checkinteger_callback,GTraces.AliasMainLFP,'Duplicate Channel',100,999},...
    'Position',[32 pos(4)-26 10 1.5],...
    'BackgroundColor',panelColor,...
    'Parent',tab2);
...
uicontrol('Style','text',...
    'Units','characters',...
    'Position',[2 pos(4)-6.5 30 2],...
    'TooltipString','Used to create trigger.txt',...
    'String','fUS Default Rate (Hz)',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
...
burst_thresh = uicontrol('Style','edit',...
    ...
    'Callback',{@checkfloat_callback,GImport.burst_thresh,'Burst Threshold',5,60},...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
% Jump threshold
uicontrol('Style','text',...
    'Units','characters',...
    'Position',[62 pos(4)-10.5 30 2],...
...
jump_thresh = uicontrol('Style','edit',...
    ...
    'Position',[92 pos(4)-10 10 2],...
    'TooltipString','Threshold for jump detection (s)',...
    'UserData',GImport_default.jump_thresh,...
    'Callback',{@checkfloat_callback,GImport.jump_thresh,'Jump Threshold',0,60},...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
...
uicontrol('Style','text',...
    'Units','characters',...
    'Position',[62 pos(4)-12.5 30 2],...
    'String','Jump Proportion',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
jump_proportion = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GImport.jump_proportion,...
    'Position',[92 pos(4)-12 10 2],...
    'TooltipString','Minimal proportion to resample (%s)',...
    'UserData',GImport_default.jump_proportion,...
    'Callback',{@checkfloat_callback,GImport.jump_proportion,'Jump Proportion',0,1},...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
...
resamp_burst = uicontrol('Style','edit',...
    ...
    'Position',[32 pos(4)-12 10 2],...
    'TooltipString','Interpolation Step BURST',...
...
resamp_cont = uicontrol('Style','edit',...
    ...
    'Position',[42 pos(4)-12 10 2],...
    'TooltipString','Interpolation Step CONTINUOUS',...
...
str='DeltaMean/std|DeltaMean/mean|DeltaMean/baseline1|DeltaMean/baseline2|DeltaMean/baseline3';
norm_extension = uicontrol('Style','text',...
    ...
    'Parent',tab1);
norm_extension.UserData.format={'std';'mean';'baseline1';'baseline2';'baseline3'};
norm_format = uicontrol('Style','popup',...
    'Units','characters',...
    'String',str,...
    'Value',GImport.Doppler_normalization_index,...
    'TooltipString','std|mean|baseline1|baseline2|baseline3',...
    'UserData',2,...
    'Position',[32 pos(4)-14.25 30 2],...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
...
uicontrol('Style','text',...
    'Units','characters',...
    'Position',[2 pos(4)-16.5 30 2],...
    'TooltipString','Baseline Tag name for Doppler Normalization',...
    'String','Baseline Tag',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
str_baseline1 = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GImport.str_baseline1,...
    'Position',[32 pos(4)-16 20 1.75],...
    'TooltipString','Default Tag (baseline1)',...
    'UserData',GImport_default.str_baseline1,...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
str_baseline2 = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GImport.str_baseline2,...
    'Position',[52 pos(4)-16 20 1.75],...
    'TooltipString','Default Tag (baseline2)',...
    'UserData',GImport_default.str_baseline2,...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
str_baseline3 = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GImport.str_baseline3,...
    'Position',[72 pos(4)-16 20 1.75],...
    'TooltipString','Default Tag (baseline3)',...
    'UserData',GImport_default.str_baseline3,...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
strict_baseline = uicontrol('Style','checkbox',...
        'Units','characters',...
        'Value',GImport.strict_baseline,...
        'Position',[92 pos(4)-16 10 2],...
        'TooltipString','Strictly matches (checked) / Contains only (unchecked)',...
        'UserData',GImport_default.strict_baseline,...
        'Parent',tab1);   
...
lload_extension = uicontrol('Style','text',...
    ...
    'Position',[2 pos(4)-24.5 30 2],...
    'HorizontalAlignment','left',...
    'String','LFP Importation/ Exportation',...
    'BackgroundColor',panelColor,...
    'TooltipString',sprintf('LFP Import / Export mode'),...
    'Parent',tab1);
...
lload_format = uicontrol('Style','popup',...
    ...
    'UserData',2,...
    'Position',[32 pos(4)-24.25 30 2],...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
lexport_extension.UserData.format={'ns1';'ns2';'ns3';'ns4';'ns5';'ns6';'all'};
lexport_format = uicontrol('Style','popup',...
    'Units','characters',...
    'String',str,...
    'Value',GImport.LFP_exporting_index,...
    'TooltipString','ns1|ns2|ns3|ns4|ns5|ns6|all',...
    'UserData',2,...
    'Position',[62 pos(4)-24.25 30 2],...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
...
uicontrol('Style','text',...
    'Units','characters',...
    'Position',[62 pos(4)-32.5 30 2],...
    'TooltipString','Region/Group FontSize',...
    'String','Neuroshop Sticker FontSize',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
sticker_fontsize = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GImport.sticker_fontsize,...
    'Position',[92 pos(4)-32 10 1.75],...
    'TooltipString','10 (default)',...
    'UserData',GImport_default.sticker_fontsize,...
    'Callback',{@checkfloat_callback,GImport.sticker_fontsize,'Neuroshop Sticker FontSize',5,50},...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
...
uicontrol('Style','text',...
    'Units','characters',...
    'Position',[2 pos(4)-34.5 30 2],...
    'TooltipString','Ignore regions starting with this pattern',...
    'String','Region Ignore Pattern',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
pattern_ignore1 = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GImport.pattern_ignore1,...
    'Position',[32 pos(4)-34 20 1.75],...
    'TooltipString','region (default)',...
    'UserData',GImport_default.pattern_ignore1,...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
pattern_ignore2 = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GImport.pattern_ignore2,...
    'Position',[52 pos(4)-34 20 1.75],...
    'TooltipString','% (default)',...
    'UserData',GImport_default.pattern_ignore2,...
    'BackgroundColor',panelColor,...
    'Parent',tab1);

% Region loading
d_ledger = dir(fullfile(GParams.SEED_ATLAS,'*.txt'));
d_ledger = d_ledger(arrayfun(@(x) ~strcmp(x.name(1),'.'),d_ledger));
str = {d_ledger(:).name};
index_ledger = find(strcmp(str,GImport.ledger_name)==1);
if ~isempty(index_ledger)
    val = index_ledger;
else
    val = 1;
    warning('Current Ledger Name [%s] not found in [%s].',GImport.ledger_name,GParams.SEED_ATLAS);
end 
uicontrol('Style','text',...
    'Units','characters',...
    'Position',[2 pos(4)-36.5 30 2],...
    'HorizontalAlignment','left',...
    'String','Region Group Ledger',...
    'BackgroundColor',panelColor,...
    'TooltipString',sprintf('Used for Region Group importation'),...
    'Parent',tab1);
ledger_name = uicontrol('Style','popup',...
    'Units','characters',...
    'String',str,...
    'Value',val,...
    'Position',[32 pos(4)-36.25 30 2],...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
str = {'NShop Regions';'NLab Regions';'both'};
val = find(strcmp(str,GImport.ledger_importmode)==1);
ledger_importmode = uicontrol('Style','popup',...
    'Units','characters',...
    'String',str,...
    'Value',val,...
    'UserData',3,...
    'Position',[62 pos(4)-36.25 30 2],...
    'TooltipString','Type of regions included in Group',...
    'BackgroundColor',panelColor,...
    'Parent',tab1);
...
% Broad
delta = [6,8,10,12,14,18,20,22,24,26,28,30,32,34,36];
uicontrol('Style','text',...
    'Units','characters',...
...
uicontrol('Style','text',...
    ...
    'BackgroundColor',panelColor,...
    'Parent',tab3);
ui_beta_inf = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GFilt.beta_inf,...
    'Position',[32 pos(4)-delta(8) 10 2],...
    'BackgroundColor',panelColor,...
    'TooltipString','Down Freq',...
    'UserData',GFilt_default.beta_inf,...
    'Parent',tab3);
ui_beta_sup = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GFilt.beta_sup,...
    'Position',[42 pos(4)-delta(8) 10 2],...
    'BackgroundColor',panelColor,...
    'TooltipString','Up Freq',...
    'UserData',GFilt_default.beta_sup,...
    'Parent',tab3);
ui_beta_smooth = uicontrol('Style','edit',...
    'Units','characters',...
    'String',GFilt.beta_smooth,...
    'Position',[52 pos(4)-delta(8) 10 2],...
    'BackgroundColor',panelColor,...
    'TooltipString','Smoothing constant (s)',...
    'UserData',GFilt_default.beta_smooth,...
    'Parent',tab3);
set(ui_beta_inf,'Callback',{@checkfloat_callback,GFilt.beta_inf,'Freq inf',0,500});
set(ui_beta_sup,'Callback',{@checkfloat_callback,GFilt.beta_sup,'Freq sup',0,500});
set(ui_beta_smooth,'Callback',{@checkfloat_callback,GFilt.beta_smooth,'T smooth',0,60});
...
uicontrol('Style','text',...
    'Units','characters',...
    'Position',[2 pos(4)-delta(14)-.5 30 2],...
    'String','Ripple band',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab3);
ui_ripple_inf = uicontrol('Style','edit',...
    ...
    'Position',[32 pos(4)-delta(14) 10 2],...
    'BackgroundColor',panelColor,...
    'TooltipString','Down Freq',...
...
ui_ripple_sup = uicontrol('Style','edit',...
    ...
    'Position',[42 pos(4)-delta(14) 10 2],...
    'BackgroundColor',panelColor,...
    'TooltipString','Up Freq',...
...
ui_ripple_smooth = uicontrol('Style','edit',...
    ...
    'Position',[52 pos(4)-delta(14) 10 2],...
    'BackgroundColor',panelColor,...
    'TooltipString','Smoothing constant (s)',...
...
uicontrol('Style','text',...
    'Units','characters',...
    'Position',[2 pos(4)-delta(15)-.5 30 2],...
    'String','Ripple Detection',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab3);
str = {'detect_ripples_both.m';'detect_hippocampal_ripples.m'};
val = find(strcmp(str,GFilt.ripple_detection_algo)==1);
ripple_detection_algo = uicontrol('Style','popup',...
    'Units','characters',...
    'String',str,...
    'TooltipString','Name of script used for detection',...
    'Value',val,...
    'UserData',1,...
    'Position',[32 pos(4)-delta(15)-.25 30 2],...
    'BackgroundColor',panelColor,...
    'Parent',tab3);
