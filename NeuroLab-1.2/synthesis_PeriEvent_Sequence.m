...
% Parameters
if nargin ==0
    all_event_names = {'[NREM]Ripples-Merged-All';'[QW]Ripples-Merged-All';'[AW]Ripples-Merged-All'};
end
...
for index_event=1:length(all_event_names)
    ...
    if exist(fullfile(folder_dest,strcat(event_name,'.mat')),'file')
        ...
        list_regions = {'ISO-ACA-L';'ISO-ACA-R';...
            'ISO-AI-L';'ISO-AI-R';...
            'ISO-AUD-L';'ISO-AUD-R';...
            'ISO-Ect-L';'ISO-Ect-R';...
            'ISO-GU-L';'ISO-GU-R';...
            ...
            'OLF-COA-L';'OLF-COA-R';...
            'OLF-TT-L';'OLF-TT-R';...
            'HPF-dHIP-L';'HPF-dHIP-R';...
            'HPF-vHIP-L';'HPF-vHIP-R';...
            'RHP-dSUB-L';'RHP-dSUB-R';...
            'RHP-vSUB-L';'RHP-vSUB-R';...
            'RHP-ENT-L';'RHP-ENT-R';...
