...
GImport.str_baseline1 = 'BASELINE';
GImport.str_baseline2 = 'BASELINE-QW';
GImport.str_baseline3 = 'BASELINE-AW';
GImport.strict_baseline = true;
...
GImport.LFP_exporting_index = 2;
GImport.LFP_exporting = 'ns2';
...
GFilt.delta_inf = 1;
GFilt.delta_sup = 4;
GFilt.delta_smooth = 1;
GFilt.theta_inf = 6;
GFilt.theta_sup = 10;
GFilt.theta_smooth = 1;
GFilt.beta_inf = 10;
GFilt.beta_sup = 30;
GFilt.beta_smooth = 1;
...
g_colors = get(groot,'DefaultAxesColorOrder');
all_names = {'QW';'AW';'NREM';'REM';'REM-PHASIC';'REM-TONIC';'WAKE';'SLEEP';'RUN'};
all_strings = {'QW-';'AW-';'NREM-/S1-';'REM-/S2-';'REMPHASIC-/SURGE';'REMTONIC-/TONIC';'WAKE-';'SLEEP-';'RUN-'};
all_colors = g_colors;
all_colors(1:9,:) = [.47 .67 .19;...
    0 .45 .74;...
    .93 .69 .19;...
    .85 .33 .1;...
    .64 .08 .18;...
