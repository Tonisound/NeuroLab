...
for i = 1:length(all_files)
    ...
    uicontrol('Style','text',...
        'Units','characters',...
        'Position',[2 pos(4)-52 30 2],...
        'BackgroundColor',panelColor,...
        'HorizontalAlignment', 'left',...
        'String','Dat Directory',...
        'Parent',tab1);
    e24 = uicontrol('Style','text',...
        'Units','characters',...
        'Position',[32 pos(4)-51.5 38 1.5],...
        'BackgroundColor',backColor,...
        'HorizontalAlignment', 'left',...
        'String',FILES(cur_file).dir_dat,...
        'TooltipString','.dir_dat',...
        'Parent',tab1);
     uicontrol('Style','text',...
        'Units','characters',...
        'Position',[2 pos(4)-54 30 2],...
        'BackgroundColor',panelColor,...
        'HorizontalAlignment', 'left',...
        'String','Dat File',...
        'Parent',tab1);
    e25 = uicontrol('Style','text',...
        'Units','characters',...
        'Position',[32 pos(4)-53.5 38 1.5],...
        'BackgroundColor',backColor,...
        'HorizontalAlignment', 'left',...
        'String',FILES(cur_file).dat,...
        'TooltipString','.dat',...
        'Parent',tab1);
