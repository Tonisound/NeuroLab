...
cb2 = uicontrol('Units','normalized','Parent',f,'Style','checkbox','ToolTipString','Display Abs Value','Tag','Checkbox2','Value',0);
...
if handles.Checkbox2.Value
    im1 = imagesc(abs(R(index_rec,index_ref1).pixels_b),'Parent',ax1);
else
...
cla(ax2);
if handles.Checkbox2.Value
    im2 = imagesc(abs(R(index_rec,index_ref2).pixels_b),'Parent',ax2);
else
