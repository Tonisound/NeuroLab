...
global SEED SEED_SWL DIR_SAVE DIR_FIG DIR_STATS DIR_SYNT ;
...
uicontrol('Style','text',...
    ...
    'String','Recording List Directory',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab0);
...
dload_format = uicontrol('Style','popup',...
    ...
    'TooltipString','full|dummy',...
    'UserData',1,...
    'Position',[32 pos(4)-14 30 2],...
    'BackgroundColor',panelColor,...
    'Parent',tab3);
