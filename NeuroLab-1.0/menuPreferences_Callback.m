...
load('Preferences.mat','GParams','GDisp','GTraces','GImport',...
    'GParams_default','GDisp_default','GTraces_default','GImport_default','selected_tab');
...
set(resetAllparamButton,'Callback',@resetAllparamButton_callback);
    ...
    function okButton_callback(~,~)
        ...
        save('Preferences.mat','GParams','GDisp','GTraces','GImport','selected_tab','-append');
