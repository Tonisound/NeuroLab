...
global SEED SEED_SPIKO SEED_SWL SEED_REGION SEED_CONFIG DIR_SAVE DIR_FIG DIR_STATS DIR_SYNT ;
load('Preferences.mat','GParams','GDisp','GTraces','GImport','GFilt',...
...
tab1 = uitab(tabgp,'Title','Display');
tab2 = uitab(tabgp,'Title','Traces');
tab3 = uitab(tabgp,'Title','Importation');
tab4 = uitab(tabgp,'Title','Filtering');
...
set(resetAllparamButton,'Callback',@resetAllparamButton_callback);
    ...
    function okButton_callback(~,~)
        ...
        SEED_SPIKO=get(ui_seed_spiko,'String');
        ...
        save('Preferences.mat','GParams','GDisp','GFilt','GTraces','GImport','selected_tab','-append');
...
uicontrol('Style','text',...
    ...
    'String','Spiko Directory',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab0);
ui_seed_spiko = uicontrol('Style','edit',...
    'Units','characters',...
    'String',SEED_SPIKO,...
    'Position',[22 pos(4)-8 W-22 2],...
    'Callback',{@checkdir_callback,SEED_SPIKO,'SEED_SPIKO'},...
    'TooltipString','SEED_SPIKO',...
    'UserData',GParams_default.SEED_SPIKO,...
    'BackgroundColor',panelColor,...
    'Parent',tab0);
...
ui_sep_swl_2 = uicontrol('Style','edit',...
    ...
    'Position',[22+(W-22)/2 pos(4)-12 (W-22)/2 2],...
    'BackgroundColor',panelColor,...
    'Parent',tab0);
...
framerate = uicontrol('Style','edit',...
    ...
    'Callback',{@checkinteger_callback,GTraces.FrameRate,'Frame Rate',1,10},...
...
uicontrol('Style','text',...
    'Units','characters',...
    'Position',[2 pos(4)-6.5 30 2],...
    'String','Burst Threshold Detection',...
    'HorizontalAlignment','left',...
    'BackgroundColor',panelColor,...
    'Parent',tab3);
burst_thresh = uicontrol('Style','edit',...
    ...
    'Position',[32 pos(4)-6 10 2],...
    'TooltipString','Threshold for burst detection',...
...
set(ui_theta_smooth,'Callback',{@checkfloat_callback,GFilt.theta_smooth,'Freq inf',0,60});
...
set(ui_delta_smooth,'Callback',{@checkfloat_callback,GFilt.delta_smooth,'Freq inf',0,60});
...
set(ui_gammalow_smooth,'Callback',{@checkfloat_callback,GFilt.gammalow_smooth,'Freq inf',0,60});
...
set(ui_gammamid_smooth,'Callback',{@checkfloat_callback,GFilt.gammamid_smooth,'Freq inf',0,60});
...
set(ui_gammahigh_smooth,'Callback',{@checkfloat_callback,GFilt.gammahigh_smooth,'Freq inf',0,60});
...
set(ui_ripple_smooth,'Callback',{@checkfloat_callback,GFilt.ripple_smooth,'Freq inf',0,60});
