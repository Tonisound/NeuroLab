...
global SEED SEED_SWL SEED_REGION SEED_CONFIG DIR_SAVE DIR_FIG DIR_STATS DIR_SYNT ;
...
ui_sep_swl_2 = uicontrol('Style','edit',...
    ...
    'Position',[22+(W-22)/2 pos(4)-10 (W-22)/2 2],...
    'BackgroundColor',panelColor,...
    'Parent',tab0);
