...
if ~isempty(FILES)
    ...
    e21 = uicontrol('Style','text',...
        ...
        'Parent',tab1);
    e21.String = sprintf('%s [%s]',d2.reference,d2.padding);
    uicontrol('Style','text',...
        'Units','characters',...
    ...
    edits = [e1;e2;e3;e4;e5;e6;e7;e8;e9;e10;e11;e12;e13;e14;e15;e16;e17;e18;e19;e20;e21;e22;e100];
...
switch flag
    ...
    function uitable_select(hObj,evnt,edits)
        ...
        if ~isempty(evnt.Indices)
            ...
            edits(22).String = files_temp(cur_file).type;
