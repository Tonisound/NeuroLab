...
if ~isempty(FILES)
    ...
    normalization = '';
    if exist(fullfile(DIR_SAVE,FILES(CUR_FILE).nlab,'Doppler_normalized.mat'),'dir')
        load(fullfile(DIR_SAVE,FILES(CUR_FILE).nlab,'Doppler_normalized.mat'),'normalization');
    end
    uicontrol('Style','text',...
        'Units','characters',...
    ...
    edits = [e1;e2;e3;e4;e5;e6;e7;e8;e9;e10;e11;e12;e13;e14;e15;e16;e17;e18;e19];
...
switch flag
    ...
    function uitable_select(hObj,evnt,edits)
        ...
        if ~isempty(evnt.Indices)
            ...
            if exist(fullfile(DIR_SAVE,files_temp(cur_file).nlab,'Doppler_normalized.mat'),'dir')
            ...
            edits(17).String = data_norm.normalization;
            edits(18).String = files_temp(cur_file).type;
